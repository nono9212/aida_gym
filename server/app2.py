...
minmax = {"_height_forgiveness" : [0.005, 0.5],
          ...
          "_mimic_forgiveness": [0.05, 5.0],
          "_mimic_weight": [0.0, 20.0],
          "_speed_forgiveness": [0.1, 10.0],
...
@app.callback([Output('rewards-chart', 'figure'),
              Output('total-reward-chart', 'figure'),Output('spin_pending', 'children')],
              [Input('interval-component', 'n_intervals'),
              Input('dropdown-simulation', 'value'),Input('submit-val', 'n_clicks')])
